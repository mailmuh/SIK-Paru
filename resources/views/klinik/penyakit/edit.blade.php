			...
			<div class="col-md-12">
				...
				<div class="card">
					<div class="card-header">
						<center><strong>EDIT DATA PENYAKIT</strong></center>
					</div>
					<div class="card-body">
						<form action="{{ route('datapenyakits.update', $datapenyakit->id_penyakit) }}" method="POST">
							...
							<div class="form-row">
								<div class="form-group col-md-6">
									...
									<textarea name="gejala" placeholder="Masukan Gejala Penyakit" rows="3" class="form-control" required>{{ $datapenyakit->gejala }}</textarea>
								</div>
							</div>
